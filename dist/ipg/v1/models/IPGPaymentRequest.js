...
exports.instanceOfIPGPaymentRequest = instanceOfIPGPaymentRequest;
exports.IPGPaymentRequestFromJSON = IPGPaymentRequestFromJSON;
exports.IPGPaymentRequestFromJSONTyped = IPGPaymentRequestFromJSONTyped;
exports.IPGPaymentRequestToJSON = IPGPaymentRequestToJSON;
exports.IPGPaymentRequestToJSONTyped = IPGPaymentRequestToJSONTyped;
exports.validateIPGPaymentRequest = validateIPGPaymentRequest;
const runtime_1 = require("../../../runtime");
const Money_1 = require("./Money");
const IPGPaymentRequestAdditionalInfo_1 = require("./IPGPaymentRequestAdditionalInfo");
 ...
 */
function instanceOfIPGPaymentRequest(value) {
...
function IPGPaymentRequestFromJSON(json) {
    return IPGPaymentRequestFromJSONTyped(json, false);
}
function IPGPaymentRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'additionalInfo': (0, IPGPaymentRequestAdditionalInfo_1.IPGPaymentRequestAdditionalInfoFromJSON)(json['additionalInfo']),
        'urlParams': json['urlParams'] == null ? undefined : (json['urlParams'].map(UrlParam_1.UrlParamFromJSON)),
    };
}
function IPGPaymentRequestToJSON(json) {
    return IPGPaymentRequestToJSONTyped(json, false);
}
function IPGPaymentRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
        ...
        'additionalInfo': (0, IPGPaymentRequestAdditionalInfo_1.IPGPaymentRequestAdditionalInfoToJSON)(value['additionalInfo']),
...
function validateIPGPaymentRequest(value) {
    ...
    validationErrorContexts.push(...(0, IPGPaymentRequestAdditionalInfo_1.validateIPGPaymentRequestAdditionalInfo)(value.additionalInfo));
    return validationErrorContexts;
}
