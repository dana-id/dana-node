...
export function PaymentViewFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaymentView {
    ...
    return {
        ...
        'payOptionInfos': json['payOptionInfos'] == null ? undefined : ((json['payOptionInfos'] as Array<any>).map(PayOptionInfoFromJSON)),
...
export function PaymentViewToJSONTyped(value?: PaymentView | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'payOptionInfos': value['payOptionInfos'] == null ? undefined : ((value['payOptionInfos'] as Array<any>).map(PayOptionInfoToJSON)),
